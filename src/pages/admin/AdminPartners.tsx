      ...
      <div className="bg-white shadow rounded-lg overflow-hidden">
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {[1, 2, 3].map((item) => (
              <tr key={item}>
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Partner Corp {item}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{item === 1 ? 'Platinum' : 'Gold'}</td>
